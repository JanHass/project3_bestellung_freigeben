sap.ui.define([
    ...
    return BaseController.extend("odatatmp1.controller.List", {
        ...
        onSearch: function (oEvent) {
            ...
            // if (sQuery) {
            //     var aFilters = []
            //     this._oListFilterState.aSearch = [new Filter("Supplier", FilterOperator.Contains, sQuery)];
			...
			if (sQuery && sQuery.length > 0) {
				...
				aFilters.push(filterPurchaseOrder);
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "odatatmp1.view.ViewSettingsDialog",
                    controller: this
        ...
        _showDetail: function (oItem) {
            ...
            this.getRouter().navTo("object", {
                objectId : oItem.getBindingContext().getProperty("PurchaseOrder")
            }, bReplace);
        },
